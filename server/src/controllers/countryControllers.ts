...
//     const capital =
//       typeof req.query.capital === "string"
//         ? req.query.capital.trim()
//         : undefined;
//     const region =
...
//       return res.status(400).json({
//         message:
//           "Bad Request: At least one search parameter (name, capital, region, timezone) is required.",
//       });
//     }
...
//     if (capital) searchParams.capital = capital;
//     if (region) searchParams.region = region;
//     if (timezone) searchParams.timezone = timezone;

//     console.log(
//       `[Controller] Searching countries with parameters:`,
//       searchParams
//     );
//     const countries: CountryData[] = await countryService.searchCountries(
//       searchParams
//     );

//     console.log(
//       `[Controller] Search successful, found ${countries.length} countries.`
//     );
//     res.status(200).json(countries);
